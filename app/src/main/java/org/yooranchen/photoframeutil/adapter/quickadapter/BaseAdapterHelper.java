 ...
 */
package org.yooranchen.photoframeutil.adapter.quickadapter;
...
public class BaseAdapterHelper {
    ...
    /**
     * Will set the imageList of an ImageView from a resource id.
     * @param viewId     The view id.
     * @param imageResId The imageList resource id.
     * @return The BaseAdapterHelper for chaining.
     */
    ...
    /**
     * Will set the imageList of an ImageView from a drawable.
     * @param viewId   The view id.
     * @param drawable The imageList drawable.
     * @return The BaseAdapterHelper for chaining.
     */
    ...
    /** Add an action to set the imageList of an imageList view. Can be called multiple times. */
