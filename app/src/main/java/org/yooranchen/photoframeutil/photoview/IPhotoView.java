...
public interface IPhotoView {
    ...
    /**
     * Controls how the imageList should be resized or moved to match the size of the ImageView. Any
    ...
    /**
     * Extracts currently visible area to Bitmap object, if there is no imageList loaded yet or the
